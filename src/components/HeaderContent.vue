    ...
    <div class="main_header_elements p-3">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 d-flex justify-content-center p-0 m-0 mt-3">
                    <ul class="menu_list d-flex m-0 p-0">
                        <li class="menu_element">
                            <router-link class="menu_item text-white" :to="{ name: 'home'}">HOME</router-link>
                        </li>
                        <li class="menu_element">
                            <router-link class="menu_item ml-15 text-white" :to="{ name: 'contacts'}">CONTACTS</router-link>
                        </li>
                    </ul>
                </div>
            </div>
